...
class SFGTemporalOverlapGUI(QWidget):
    ...
    def initUI(self):
        ...
        # Initially, hardware is off so disable "Deactivate Hardware"
        ...
        # Initialize an empty image for real-time updates
    ...
    def activateHardware(self):
        try:
            ...
            # Disable activate button and enable deactivate button.
    ...
    def deactivateHardware(self):
        try:
            ...
            # Disable deactivate button and enable activate button.
            self.deactivateButton.setEnabled(False)
            self.activateButton.setEnabled(True)
        except Exception as e:
    ...
    def start_measurement(self):
        try:
            # Automatically activate hardware if it is not already active.
