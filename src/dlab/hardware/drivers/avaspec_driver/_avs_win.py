...
if 'linux' in sys.platform: # Linux will have 'linux' or 'linux2'
    ...
    if (ctypes.sizeof(ctypes.c_voidp) == 8): # 64 bit
        ...
        try:
            lib = ctypes.WinDLL("../../hardware/drivers/avaspec_driver/avaspecx64.dll") #If executed in diagnostics
        except FileNotFoundError:
            lib = ctypes.WinDLL("./src/dlab/hardware/drivers/avaspec_driver/avaspecx64.dll") #If executed in Dlabcontroller
